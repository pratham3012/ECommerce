package com.mibtech.nbcustomer.prodcutscategory;
...
import com.mibtech.nbcustomer.Cart;
import com.mibtech.nbcustomer.IndividualProduct;
import com.mibtech.nbcustomer.NotificationActivity;
import com.mibtech.nbcustomer.R;
import com.mibtech.nbcustomer.models.GenericProductModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirebaseRecyclerAdapter<GenericProductModel, Cards.MovieViewHolder> adapter = new FirebaseRecyclerAdapter<GenericProductModel, Cards.MovieViewHolder>(
            ...
            protected void populateViewHolder(final Cards.MovieViewHolder viewHolder, final GenericProductModel model, final int position) {
                ...
                Picasso.get(Stationary.this).load(model.getCardimage()).into(viewHolder.cardimage);
